...
//        try {
    ...
    {
        $data['listrooms'] = Room::where('loaiphong_id', $id)->get();
        dd($data['listrooms']);
        return view('frontend.room_detail', $data);
    }
    public function Listroom()
    {
        $data['listroom'] = Kind_of_room::with('rooms')->orderBy('id', 'desc')->get();
        return view('frontend.list-room', $data);
    }
    ...
    public function ShowListRoomDetail($id)
    {
        $data['listrooms'] = Kind_of_room::where('id', $id)->first();
