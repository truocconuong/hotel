...
<button  data-target="{{$delete_}}" data-url="{{ $delete }}" id="delete_user" data-toggle="modal" data-id="{{$id}}"  data-show="{{$detail}}" class="btn btn-xs btn-danger btn-flat btn-delete"
